 ...
 */
final class Version20230401150151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD code VARCHAR(255) NOT NULL, ADD slug VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products DROP code, DROP slug');
    }
}
